...
<tbody>
	...
	<tr>
		<td colspan="4">&nbsp;</td>
		<td align="right"><b>Fee already deposited at the time of last grant of CTO (-)</b></td>
		@if(isset($footer['total_noc_fee']))
	...
	<tr>
		...
		@if(isset($footer['total_noc_fee']))
        <td style="text-align: center;"><b>{{ $footer['total_noc_fee'] }}</b></td>
        @endif
        @if(isset($footer['arrear']))
        <td style="text-align: center;"><b></b></td>
        @endif
        ...
        @endif
        @if(isset($footer['total_cto_air_fee']))
        <td style="text-align: center;"><b>{{ money_format_change($footer['final_cto_air_fee']) }}</b></td>
        @endif
	</tr>
