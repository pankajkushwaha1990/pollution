                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu dropdown-menu-right">
                                            <div class="dropdown-menu-header">
                                                <div class="dropdown-menu-header-inner bg-vicious-stance">
                                                    <div class="menu-header-image opacity-4" style="background-image: url('{{ asset('/template/assets/images/dropdown-header/city5.jpg')}}');"></div>
                                                                                ...
                                                                                <div class="vertical-timeline-element-content bounce-in">
                                                                                    <h4 class="timeline-title">Something not important
                                                                                        <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                                                            ...
                                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon"><img
                                                                                                        src="{{ asset('template/assets/images/avatars/7.jpg') }}"
                                                                                                        alt=""></div>
                                                                                            </div>
                                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon"><img
                                                                                                        src="{{ asset('template/assets/images/avatars/8.jpg') }}"
                                                                                                        alt=""></div>
                                                                                            </div>
                                        ...
                                        <div class="widget-content-left">
                                            <div class="btn-group">
                                                <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                                    <img width="42" class="rounded" src="{{ asset('template/assets/images/avatars/admin_logo.png') }}" alt="">
                                                                    ...
                                                                    <div class="widget-content-wrapper">
                                                                        <div class="widget-content-left mr-3">
                                                                            <img width="42" class="rounded-circle"
                                                                                 src="{{ asset('template/assets/images/avatars/admin_logo.png') }}"
                                                                                 alt="">
                                                                        </div>
                                                                        <div class="widget-content-left">
                                                                            <div class="widget-heading">{{ session()->get('name') }}
                                                                            </div>
                                                                            <div class="widget-subheading opacity-8">{{ session()->get('email') }}
                                                                            </div>
                                                                        </div>
                                                                        <div class="widget-content-right mr-2">
                                                                            <a href="{{ route('logout') }}"><button class="btn-pill btn-shadow btn-shine btn btn-focus">Logout
                                                                            </button></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <ul class="nav flex-column">
                                                             ...
                                                             <!--    <li class="nav-item">
                                                              ...
                                                              <!--   <li class="nav-item">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a href="{{ route('change_password') }}" class="nav-link">Settings
                                                                        <div class="ml-auto badge badge-success">Change
                                                                        </div>
                                                                    </a>
                                                                </li>
                                                              <!--   <li class="nav-item">
