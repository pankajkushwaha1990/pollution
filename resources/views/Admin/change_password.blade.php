                                                    ...
                                                    <div class="main-card mb-3 card">
                                                        <div class="card-body"><h5 class="card-title">Change Password</h5>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <label for="exampleEmail11" class="">Current Password</label>
                                                                    <input name="current_password" id="current_password" placeholder="Enter Current Password" type="password"
                                                        ...
                                                        @endif
                                                                 ...
                                                                 <div class="col-md-4">
                                                                    ...
                                                                    <input name="new_password" id="new_password" placeholder="Enter New Password" type="password"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                 ...
                                                                 <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                    <label for="exampleEmail11" class="">Confirm New Password</label>
                                                                    <input name="password_confirmation" id="password_confirmation" placeholder="Confirm New Password" type="password"
                                                                                                         class="form-control" required="">
