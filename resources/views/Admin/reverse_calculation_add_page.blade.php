 <div class="main-card mb-3 card">
    <div class="card-body">
     <form method="GET" action="{{ url('admin/reverse_calculation_cto_fee') }}" id="six_form_submit">
        <div class="form-row">
            <div class="col-md-12">
                <div class="position-relative form-group">
                    ...
                    <select name="industry_id" id="industry_id" class="form-control industry_id_six" required="">
        ...
        <div class="form-row">
            <div class="col-md-6">
             ...
             <div class="col-md-6">
                ...
                <select name="industry_noc" id="industry_noc" class="form-control industry_noc_six" required="">
            ...
            <div id="radioBtn" class="btn-group">
              <a class="btn btn-default btn-sm  currency_format_six" format='num'  data-toggle="fun" data-title="Y">Num</a>
              <a class="btn btn-default btn-sm active currency_format_six" format='lac' style="background-color: #18b3ef;" data-toggle="fun" data-title="X">Lac</a>
              <a class="btn btn-default btn-sm notActive currency_format_six" format='cr' data-toggle="fun" data-title="N">CR</a>
            </div>
            ...
            <div id="radioBtn" class="btn-group">
              <a class="btn btn-default btn-sm active  mode_type_six" format='amount'  style="background-color: #18b3ef;"  data-toggle="fun" data-title="Y">Amount</a>
              <a class="btn btn-default btn-sm  mode_type_six" format='date' data-toggle="fun" data-title="X">Date</a>
            </div> |

            &nbsp; &nbsp;  &nbsp;&nbsp; &nbsp;  &nbsp; 
            <div id="radioBtn" class="btn-group mode_div">
              <a class="btn btn-default btn-sm active  mode_format_six" format='num' style="background-color: #18b3ef;"  data-toggle="fun" data-title="Y">Num</a>
              <a class="btn btn-default btn-sm  mode_format_six" format='lac'  data-toggle="fun" data-title="X">Lac</a>
              <a class="btn btn-default btn-sm notActive mode_format_six" format='cr' data-toggle="fun" data-title="N">CR</a>
            </div>


          </label>
                                                                    <input name="duration" id="duration" placeholder="Enter Amount" type="text"
                                                                                                         class="form-control" required="">
