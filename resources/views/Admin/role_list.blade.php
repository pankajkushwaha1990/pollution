                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header-tab card-header">
                                                <div class="card-header-title font-size-lg text-capitalize font-weight-normal">
                                                    <i class="header-icon lnr-laptop-phone mr-3 text-muted opacity-6"> </i>Role List
                                                </div>
                                                    ...
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                                            ...
                                                            <button type="button" tabindex="0" class="dropdown-item">
                                                                <i class="dropdown-icon lnr-inbox"> </i><span><a href="{{ route('role_add') }}">Add New</a></span>
                                                            </button>
                                                ...
                                                <table style="width: 100%;" id="example"
                                                   ...
                                                   @forelse ($roles as $role)
                                                        <tr>
                                                           ...
                                                           <td>{{ str_replace('_',' ',implode(', ',json_decode($role->module_access))) }}</td>
                                                         </tr>
                                                    @empty
