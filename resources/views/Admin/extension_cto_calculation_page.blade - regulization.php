                        ...
                        <tr class="text-white">
                            ...
                            @if($data['penalty_changed']=='Y')
                             ...
                             @endif
                              ...
                              @if($data['penalty_changed']=='Y' && ($data['concent_type']=='water' || $data['concent_type']=='both'))
                             <th>CTO-Water Fee Penalty</th>
                             @endif
                             ...
                             <th>CTO-Air Fee</th>
                             @endif
                              @if($data['penalty_changed']=='Y' && ($data['concent_type']=='air' || $data['concent_type']=='both'))
                             <th>CTO-Air Fee Penalty</th>
                             @endif
                            ...
                            foreach ($all_data['table_details'] as $key => $detail) {
                             ?>
                                <tr>
                                    ...
                                    @endif
                                     @if($data['penalty_changed']=='Y')
                                       <th><?php $ca_diff +=0;?>CA Difference</th>
                                     @endif
                                    <?php 
                                    if($data['industry_noc']=='Y' || $data['arrear_changed']=='Y'){?>
