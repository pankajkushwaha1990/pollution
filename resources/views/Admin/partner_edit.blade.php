                                ...
                                <div class="tab-content">
                                    <div class="tab-pane tabs-animation fade show active" id="tab-content-0"
                                        ...
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form action="{{ route('partner_edit_submit') }}" method="post" id="signupForm" autocomplete="off" needs-validation" novalidate>
                                                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                                        <input type="hidden" name="partner_id" value="{{ $partner->id }}" />
                                                    <div class="main-card mb-3 card">
                                                        <div class="card-body"><h5 class="card-title">Edit Partner</h5>
                                                           ...
                                                           <div class="divider"></div>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="company_name" id="company_name" placeholder="Enter Company Name" type="text" value="{{ $partner->company_name }}"
                                                                 ...
                                                                 <div class="col-md-4">
                                                                    ...
                                                                    <label for="exampleEmail11" class="">Partner Country</label>
                                                                      ...
                                                                      @foreach ( config('app.module_country') as $key => $value) 
                                                                          <option <?php 
                                                                             if($partner->partner_country==$value){
                                                                              echo 'selected';
                                                                              }
                                                                              ?>
                                                        ...
                                                        @endif
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="partner_email_1" id="partner_email_1" placeholder="Enter First Email" type="email" value="{{ $partner->partner_email_1 }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="partner_email_2" id="partner_email_2" placeholder="Enter Second Email" type="email" value="{{ $partner->partner_email_2 }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="partner_email_3" id="partner_email_3" placeholder="Enter Third Email" type="email" value="{{ $partner->partner_email_3 }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="partner_phone_1" id="partner_phone_1" placeholder="Enter First Phone" type="number" value="{{ $partner->partner_phone_1 }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="partner_phone_2" id="partner_phone_2" placeholder="Enter Second Phone" type="number" value="{{ $partner->partner_phone_2 }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="partner_phone_3" id="partner_phone_3" placeholder="Enter Third Phone" type="number" value="{{ $partner->partner_phone_3 }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="partner_url" id="partner_url" placeholder="Enter Website URL" type="url" value="{{ $partner->partner_url }}"
                                                                                                         class="form-control" required="">
...
<br>
                                                           ...
                                                           <div class="form-row">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="first_name" id="first_name" placeholder="Enter First Name" type="text" value="{{ $partner->first_name }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                 ...
                                                                 <div class="col-md-4">
                                                                    ...
                                                                    <input name="last_name" id="last_name" placeholder="Enter Last Name" type="text" value="{{ $partner->last_name }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                    <label for="exampleEmail11" class="">Email 1</label>
                                                                    <input name="contact_email_1" id="contact_email_1" placeholder="Enter First Email" type="email" value="{{ $partner->contact_email_1 }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                    <label for="exampleEmail11" class="">Email 2</label>
                                                                    <input name="contact_email_2" id="contact_email_2" placeholder="Enter Second Email" type="email" value="{{ $partner->contact_email_2 }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                 ...
                                                                 <div class="col-md-4">
                                                                    ...
                                                                    <input name="contact_phone_1" id="contact_phone_1" placeholder="Enter First Phone" type="number" value="{{ $partner->contact_phone_1 }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="contact_phone_2" id="contact_phone_2" placeholder="Enter Second Phone" type="nuberm" value="{{ $partner->contact_phone_2 }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                             ...
                                                             <div class="form-row">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="contact_job_title" id="contact_job_title" placeholder="Enter Job Title" type="text" value="{{ $partner->contact_job_title }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                 ...
                                                                 <div class="col-md-4">
                                                                    ...
                                                                    <input name="contact_department" id="contact_department" placeholder="Enter Department" value="{{ $partner->contact_department }}" type="text"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="contact_skype_id" id="contact_skype_id" placeholder="Enter Skype Id" type="text" value="{{ $partner->contact_skype_id }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="billing_name" id="billing_name" placeholder="Enter Billing Name" type="text" value="{{ $partner->billing_name }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                 ...
                                                                 <div class="col-md-4">
                                                                    ...
                                                                    <input name="partner_address_1" id="partner_address_1" placeholder="Enter Address 1" type="text" value="{{ $partner->partner_address_1 }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                             ...
                                                             <div class="form-row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="partner_address_2" id="partner_address_2" placeholder="Enter Secondry Address" type="text" value="{{ $partner->partner_address_2 }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="partner_state" id="partner_state" placeholder="Enter State" type="text" value="{{ $partner->partner_state }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                 ...
                                                                 <div class="col-md-4">
                                                                    ...
                                                                    <input name="partner_zipcode" id="partner_zipcode" placeholder="Enter Postal/Zip Code" type="text" value="{{ $partner->partner_zipcode }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="partners_country" id="partners_country" placeholder="Enter Country" type="text" value="{{ $partner->partners_country }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="tax_id_number" id="tax_id_number" placeholder="Enter Tax ID" type="text" value="{{ $partner->tax_id_number }}"
                                                                                                         class="form-control" required="">
