                                                    ...
                                                    <div class="main-card mb-3 card">
                                                        ...
                                                        @endif
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input name="industry_latitude" id="industry_latitude" placeholder="Enter Industry Latitude" type="text"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input name="industry_longitude" id="industry_longitude" placeholder="Enter Industry Longitude" type="text"
                                                                                                         class="form-control" required="">
