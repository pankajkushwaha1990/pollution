                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header-tab card-header">
                                                <div class="card-header-title font-size-lg text-capitalize font-weight-normal">
                                                    <i class="header-icon lnr-laptop-phone mr-3 text-muted opacity-6"> </i>Partners List
                                                </div>
                                                    ...
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                                            ...
                                                            <button type="button" tabindex="0" class="dropdown-item">
                                                                <i class="dropdown-icon lnr-inbox"> </i><span><a href="{{ route('partner_add') }}">Add New</a></span>
                                                            </button>
                                                ...
                                                <table style="width: 100%;" id="example"
                                                   ...
                                                   @forelse ($roles as $role)
                                                        <tr>
                                                           ...
                                                           <td>{{ $role->admin_first_name }}</td>
                                                           <td>{{ $role->created_at }}</td>
                                                           <td>
                                                            @if($role->status==1)
                                                              <div title="click to deactivate" class="mb-2 mr-2 badge badge-pill badge-success">
                                                                    <a style="color:white;" href="{{ route('partner_change_status',['id'=>$role->id,'status'=>0]) }}">Active</a>
                                                                </div>
                                                            @else
                                                            <div title="click to activate" class="mb-2 mr-2 badge badge-pill badge-danger">
                                                                    <a style="color:white;" href="{{ route('partner_change_status',['id'=>$role->id,'status'=>1]) }}">Inactive</a>
                                                                </div>
                                                            @endif
                                                           </td>
                                                            <td>
                                                              <a href="{{ route('partner_edit',['id'=>$role->id]) }}"><i class="header-icon lnr lnr-pencil mr-3 text-success"> </i></a>
                                                              
                                                        <a data-toggle="modal" class="delete_user" data-target="#exampleModal" href="{{ route('partner_delete',['id'=>$role->id]) }}"><i class="header-icon lnr lnr-trash mr-3 text-danger"> </i></a>
                                                          </td>
