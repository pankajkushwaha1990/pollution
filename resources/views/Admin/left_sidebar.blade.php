            <div class="app-sidebar-wrapper">
                <div class="app-sidebar bg-asteroid sidebar-text-light">
                    <div class="app-header__logo" style="background-color: white;">
                        <a href="{{ route('dashboard') }}" data-toggle="tooltip" data-placement="bottom" title="{{ config('app.project_name') }} Admin Template" class="logo-src1"><img style="width: 44px;height: 44px;" src="{{ config('app.project_logo')  }}"></a>
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                               ...
                               <!--  <li class="mm-active">
                                    ...
                                    <ul class="mm-show">           
                                        <li>
                                            <a href="{{ route('company_financial_api') }}">
                                                <i class="metismenu-icon pe-7s-graph">
                                                </i>Get From API
                                            </a>
                                        </li>
