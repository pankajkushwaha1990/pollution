...
<div class="app-container app-theme-gray">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane tabs-animation fade show active" id="tab-content-0"
                                        ...
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form action="{{ route('user_edit_submit') }}" method="post" id="signupForm" autocomplete="off" needs-validation" novalidate>
                                                    ...
                                                    <div class="main-card mb-3 card">
                                                        <div class="card-body"><h5 class="card-title">Edit User</h5>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input name="first_name" id="first_name" placeholder="Enter First Name" type="text" value="{{ $user->first_name }}" 
                                                        ...
                                                        @endif
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input name="last_name" id="last_name" placeholder="Enter Last Name" type="text" value="{{ $user->last_name }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                             ...
                                                             <div class="form-row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input name="email" id="first_name" placeholder="Enter email Address" type="email" value="{{ $user->email }}"
                                                                                                         class="form-control" required="">
                                                         @if($errors->has('email'))
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select class="form-control" name="role" required="">
                                                                      ...
                                                                      @foreach ($roles as $key => $value) 
                                                                          <option {{ $user->role == $value->id ? 'selected' : '' }}  value="{{ $value->id }}">{{ $value->role_name }}</option>
                                                                      @endforeach
                                                                    </select>
                                                                     @if($errors->has('role'))
 ...
 <div class="form-row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input name="username" id="username" placeholder="Enter username" type="text" value="{{ $user->username }}"
                                                                                                         class="form-control" required="">
                                                        ...
                                                        @endif
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input name="password" id="password" placeholder="Enter Password" type="text" value="{{ $user->password }}"
                                                                                                         class="form-control" required="">
