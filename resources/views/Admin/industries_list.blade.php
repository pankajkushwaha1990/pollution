                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header-tab card-header">
                                                <div class="card-header-title font-size-lg text-capitalize font-weight-normal">
                                                    <i class="header-icon lnr-laptop-phone mr-3 text-muted opacity-6"> </i>Industries List
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <table style="width: 100%;" id="example"
                                                   ...
                                                   @forelse ($roles as $role)
                                                        <tr>
                                                           <td>{{ ucfirst($role->category_name) }}</td>
                                                           <td>{{ ucfirst($role->industry_name) }}</td>
                                                           <td>{{ ucfirst($role->mobile) }}</td>
                                                           <td>{{ ucfirst($role->email) }}</td>
                                                           <td>{{ ucfirst($role->industry_scale) }}</td>
                                                           <td> <a href="{{ route('industry_edit',['id'=>$role->id]) }}"><i class="header-icon lnr lnr-pencil mr-3 text-success"> </i></a></td>
