                    ...
                    <thead class="bg-none bgc-default-tp1">
                        <tr class="text-white">
                            ...
                            @endif !}
                             ...
                             <th>NOC Fee</th>
                             @endif
                              @if(($data['industry_noc']=='Y' || $data['arrear_changed']=='Y') && $data['concent_type']=='air' || $data['concent_type']=='both') 
                             <th>NOC Air Fee</th>
                             @endif
                              @if(($data['industry_noc']=='Y' || $data['arrear_changed']=='Y') && $data['concent_type']=='water' || $data['concent_type']=='both') 
                             <th>NOC Water Fee</th>
                             @endif
                        ...
                        foreach($data['previous_data'] as $previous){
                            ...
                            foreach ($all_data['table_details'] as $key => $detail) {
                             ...
                             <td class="text-secondary-d2">
                                        ...
                                        if($sr_no==2){
                                            ...
                                            echo $data['new_cte_fee'];
                                            $total_noc_air+=$data['new_cte_fee'];
                                        }else{
                            ...
                            <td class="text-secondary-d2">
                                        ...
                                        if($sr_no==2){
                                            ...
                                            echo $data['new_cte_fee'];
                                            $total_noc_water+=$data['new_cte_fee'];
                                        }else{
                             ...
                             <?php 
                                    if($data['industry_noc']=='Y' || $data['arrear_changed']=='Y'){?>
                                      ...
                                      <?php }?>
                                       ...
                                       @if(($data['industry_noc']=='Y' || $data['arrear_changed']=='Y') && $data['concent_type']=='air' || $data['concent_type']=='both') 
                             <th><?php  $final_amount += $total_noc_air; ?>{{ $total_noc_air }}</th>
                             @endif
                              @if(($data['industry_noc']=='Y' || $data['arrear_changed']=='Y') && $data['concent_type']=='water' || $data['concent_type']=='both') 
                             <th><?php  $final_amount += $total_noc_water; ?>{{ $total_noc_water }}</th>
                             @endif
